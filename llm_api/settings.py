...
SECRET_KEY = "django-insecure-^&7&4g(h!j-9z50kv)mvd1ya!x2oeddfj^#%b$nmsm_nu-hzi6"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*'] # 개발환경에서만 사용
...
LOGGING = {
    ...
    'loggers': {
        ...
        'agent': {  # 앱 로거
            'handlers': ['console', 'file'],
            'level': 'DEBUG',  # 디버그 레벨까지 로깅
            'propagate': False,  # 중복 로깅 방지
        },
        'agent.views': {  # views.py 전용 로거
            'handlers': ['console', 'file'],
            'level': 'DEBUG',
            'propagate': False,
        },
